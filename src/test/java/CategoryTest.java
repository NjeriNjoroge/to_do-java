...
//for Category to have the same ID as their data in the database
@Test
...
//retrieving all Tasks saved into a specific Category
@Test
...
//comparing Category objects using .equals()
@Test
...
//saving new Category objects into the database
@Test
